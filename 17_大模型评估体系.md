...
> **面试频率**：高（具体占比取决于岗位与样本，本文不使用无法复核的固定百分比）
>
...
### 17.11.2 Langfuse：当前平台与 Python SDK v4
...
### 17.11.3 Arize Phoenix：OpenInference tracing 与 Evals v3
...
### 17.11.4 DeepEval：Eval-as-Code、DAG 与 G-Eval
