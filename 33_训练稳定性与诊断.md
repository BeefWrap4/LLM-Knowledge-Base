...
tags:
  ...
  - Muon
---
# 第 33 章 训练稳定性与诊断：loss spike、attention sink 与 checkpoint 恢复 ⭐⭐⭐⭐

> [!abstract] 本章导航
> **定位**：把训练异常转化为可观测、可归因和可恢复的诊断流程。
>
> **先修**：[[11_深度学习与PyTorch]]、[[19_分布式训练系统]]。
>
> **学习目标**：
...
>
> **建议路径**：Loss Spike 根因分析 → Attention Sink 现象 → Gradient Norm 监控与裁剪 → … → 优化器选型诊断：AdamW vs Lion vs Muon。先完成主线，再按需要阅读进阶内容。
>
...
1. 你能否根据 loss、梯度、激活和数据证据定位训练异常？
2. 你能否设计 checkpoint、回放和恢复验收流程？
3. 你能否根据任务与稳定性证据选择优化器和裁剪策略？
