...
def calc_cost(prefix_tokens: int, dynamic_tokens: int, output_tokens: int,
              n_turns: int = 1) -> CacheStats:
    """模拟多轮对话的 prefix 缓存累积。
...
def run_demo() -> None:
    ...
    print(f"场景: prefix={8000} tokens (system+docs), dynamic={500} tokens/turn, "
          f"output={300} tokens/turn\n")
