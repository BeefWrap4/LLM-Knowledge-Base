...
MODELS_TO_DOWNLOAD = {
    ...
    "bge-small-zh": {
        ...
        "size_gb": 0.1,
        "tier": "embedding",
        "chapters": ["ch19_rag_indexing", "ch36_evaluation", "ch44_llmops", "ch29_data_engineering"],
        "required": True,
    },
    "bge-reranker": {
        ...
        "size_gb": 0.6,
        "tier": "reranker",
        "chapters": ["ch36_evaluation", "ch29_data_engineering"],
        "required": True,
    },
    # === LLM 小模型 (默认下载) ===
    "qwen0_5b": {
    ...
    "qwen7b": {
        ...
        "size_gb": 15.0,
        "tier": "llm-medium",
        "chapters": ["ch41_inference_engines"],
        "required": False,
