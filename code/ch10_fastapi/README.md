...
- [第 10 章 FastAPI 与后端服务](../../10_FastAPI与后端服务.md)
...
python code/scripts/run_all_examples.py --chapter ch10 --tier llm
python code/scripts/run_all_examples.py --chapter ch10 --tier gpu
```
