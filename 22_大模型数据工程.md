...
> 📚 **交叉引用**：Agent 框架与执行机制见 [[15_Agent技术体系]]，多轮对话数据格式见 [[16_模型微调与推理优化]]。
...
> 📚 **交叉引用**：模型安全与对抗见 [[23_大模型安全与对抗]]，模型评估污染问题见 [[17_大模型评估体系]]。
...
> 📚 **交叉引用**：对齐方法与 RLHF 详见 [[16_模型微调与推理优化]] 16.5 节，安全对齐与红队测试详见 [[23_大模型安全与对抗]]。
